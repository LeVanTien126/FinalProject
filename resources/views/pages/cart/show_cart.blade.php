                                    ...
                                    <tbody class="align-middle">
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <input type="submit" value="UP" name="update_qty" class="btn btn_default btn-sm">
                                                </form>  
                                            </td>
                                            <td>
                                                <?php
                                            ...
                                            <td > <a href="{{URL::to('/delete-to-cart/'.$v_content->rowId)}}"><button  ><i class="fa fa-trash"></i></button></a></td>
                                        </tr>
                                ...
                                <div class="col-md-12">
                                    <div class="cart-summary">
                                        <div class="cart-content">
                                            <h1>Cart Summary</h1>
                                            <p>Sub Total<span>${{Cart::total()}}</span></p>
                                    ...
                                    ?>
                                    <a href="{{URL::to('/checkout')}}"> <button>Checkout</button></a>
                                     ...
                                     ?>
                                      <a href="{{URL::to('/login-checkout')}}"> <button>Checkout</button></a>
                                     <?php
                                  }
                                    ?>
