                        ...
                        <div class="register-form">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input name="customer_name" class="form-control" type="text" placeholder="First Name">
                                </div>
                              
                                <div class="col-md-6">
                                    <label>E-mail</label>
                                    <input name="customer_email" class="form-control" type="text" placeholder="E-mail">
                                </div>
                                <div class="col-md-6">
                                    <label>Password</label>
                                    <input name="customer_password" class="form-control" type="text" placeholder="Password">
                                </div>
                                <div class="col-md-6">
                                    <label>Mobile No</label>
                                    <input name="customer_phone" class="form-control" type="text" placeholder="Mobile No">
                                </div>
                        ...
                        <div class="login-form">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input name="email_account" class="form-control" type="text" placeholder="E-mail / Username">
                                </div>
                                <div class="col-md-6">
                                    <label>Password</label>
                                    <input name="password_account" class="form-control" type="text" placeholder="Password">
                                </div>
                                <div class="col-md-12">
