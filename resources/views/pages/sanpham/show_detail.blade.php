                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-5">
                                        <div class="product-slider-single normal-slider">
                                           <img src="{{URL::to('public/upload/product/'.$value->product_image)}}" alt="Product Image">
                                    ...
                                    <div class="col-md-7">
                                        ...
                                        <div class="product-content">
                                            <div class="title"><h2>{{$value->product_name}}</h2></div>
                                            <div class="ratting">
                                               <h2>{{$value->brand_name}}</h2> 
                                            </div>
                                            ...
                                            <div class="action">
                                                ...
                                                <button type="submit" class="btn" href="#"><i class="fa fa-shopping-bag"></i>Add to cart</button> 
                                            </div>
                                        </div>
                                        </form>
                                    </div>
                                    ...
                                    <div class="col-lg-3">
                                        <div class="product-item">
                                            ...
                                            <div class="product-price">
                                                <h3><span>$</span>{{$value->product_price}}</h3>
